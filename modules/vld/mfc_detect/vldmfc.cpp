...
#elif _MFC_VER == 0x0F00    // VS 2017
#define MFCDLLNAME   _T("mfc150d.dll")
#else
#error MFC version not supported
#endif
#else
...
#elif _MFC_VER == 0x0F00    // VS 2017
#define MFCDLLNAME   _T("mfc150ud.dll")
#else
#error MFC version not supported
#endif
#endif
...
#elif _MFC_VER == 0x0F00    // VS 2017
#define MFCDLLNAME   _T("mfc150.dll")
#else
#error MFC version not supported
#endif
#else
...
#elif _MFC_VER == 0x0F00    // VS 2017
#define MFCDLLNAME   _T("mfc150u.dll")
#else
#error MFC version not supported
#endif
#endif
